...
const ListingCardSkeleton = () => (
  <div className="flex w-full flex-col overflow-hidden rounded-xl border border-black/8 bg-background-paper sm:flex-row sm:items-stretch">
    <div className="relative aspect-5/3 w-full shrink-0 sm:aspect-auto sm:min-h-[148px] sm:w-56 md:w-64 lg:w-72">
      <Skeleton
        variant="rectangular"
        animation="wave"
    ...
    <div className="flex min-w-0 flex-1 flex-col justify-between gap-2.5 p-3 sm:gap-3 sm:p-4">
      <div className="flex flex-col gap-1.5 sm:gap-2">
        ...
        <Skeleton variant="text" width="78%" height={24} animation="wave" />
      ...
      <div className="flex items-end justify-between gap-2 border-t border-black/6 pt-2.5 sm:pt-3">
        ...
        <div className="flex flex-col items-end gap-1">
          <Skeleton variant="text" width={88} height={26} animation="wave" />
